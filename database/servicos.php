...
function buscaServicosCards()
{
	...
	$servicos = chamaAPI(null, '/paginas/servicos_card', json_encode($apiEntrada), 'GET');
...
function buscaServicos($idServico=null)
{
	...
	$servicos = chamaAPI(null, '/paginas/servicos', json_encode($apiEntrada), 'GET');
...
function buscaSlugServicos($slugServicos)
{
	...
	$servicos = chamaAPI(null, '/paginas/servicos_slug', json_encode($apiEntrada), 'GET');
...
if (isset($_GET['operacao'])) {
    ...
    if ($operacao=="inserir") {
		...
		$servicos = chamaAPI(null, '/paginas/servicos', json_encode($apiEntrada), 'PUT');
    ...
    if ($operacao=="alterar") {
		...
		$servicos = chamaAPI(null, '/paginas/servicos', json_encode($apiEntrada), 'POST');
	...
	if ($operacao=="excluir") {
		...
		$servicos = chamaAPI(null, '/paginas/servicos', json_encode($apiEntrada), 'DELETE');
	}

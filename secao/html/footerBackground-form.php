...
<div class="row">
    ...
    <div class="col-sm-4">
        ...
        <input type="hidden" name="img2" value="<?php echo $parametros["backgroundIMG"] ?? null ?>">
    </div>
</div>
<hr>
<div class="row">
...
<script>
    ...
    const pictureImage = document.querySelector(".picture__image");
    const pictureImageTxt = "Carregar backgroundIMG";
    pictureImage.innerHTML = pictureImageTxt;
    ...
    inputFile.addEventListener("change", function(e) {
        ...
        if (file) {
            ...
            reader.addEventListener("load", function(e) {
                ...
                const backgroundIMG = document.createElement("img2");
